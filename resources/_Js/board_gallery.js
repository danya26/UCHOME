...
if(mainVisualEffect == undefined) {
	mainVisualEffect = function (o) {
		...
		var this_s = this;
		this.o =  $.extend({obj:null,contents:".datalist li",numctrs:".ctrl-nums .nicon",toggleBtn:true,prevBtn:null,nextBtn:null,stopBtn:null,playBtn:null,isPlay:false,speed:4000,initNum:1,flickEvt:false}, o||{});
...
mainVisualEffect.prototype.init = function () {
	...
	this.$cont.each(function(){
		...
		$(".btn",$(this)).unbind("focus").bind("focus",function(){
			this_s.setOn(n);
		});
