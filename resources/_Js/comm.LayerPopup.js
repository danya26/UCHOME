;(function($, window, document, undefined) {
    ...
    Plugin.prototype = {
		...
		, drawWindow : function() {
			...
			if (layer.options.border_radius && layer.options.border_radius !== "0") {
				layer.con_wrap.css({
					"border-radius": layer.options.border_radius,
					"overflow": "hidden"
				});
			}
			layer.con_cont = $("<div class='pop-cont'></div>");
			if (layer.options.title_bar_yn) {
		...
		, setWindowResizing : function() {
			...
			layer.options.title_height = (layer.con_head && layer.con_head.length > 0) ? layer.con_head.css("height").replace("px", "")* 1 : 0;
			...
			layer.con_wrap.animate( {
				...
				function() {
					if (typeof resetImgZoom === "function") {
						resetImgZoom();
					}
					if (typeof setMinWidthAutoScrollBox === "function") {
