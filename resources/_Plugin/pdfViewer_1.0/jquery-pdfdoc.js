...
(function ($){
    $.fn.PDFDoc = function(options){
         ...
         */
        var but_next = $('<button>', { 'type':'button', 'class' : 'h-pdf-button h-pdf-next', 'title' : 'Next Page' }).click(function(){
        ...
        var but_prev = $('<button>', { 'type':'button','class' : 'h-pdf-button h-pdf-prev', 'title' : 'Previous Page' }).click(function(){
