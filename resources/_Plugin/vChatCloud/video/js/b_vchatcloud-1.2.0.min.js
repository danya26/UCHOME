                                ...
                                if (g.enable.audio && (c.prototype.toggleRTCAudioControl = function(n) {
                                    ...
                                    if (c.prototype.toggleRTCMedia = function(n) {
                                            ...
                                            if (!(1 & g.enable.share) || (null != (e = navigator.userAgent).match(/iPhone|iPod|Android|Windows CE|BlackBerry|Symbian|Windows Phone|webOS|Opera Mini|Opera Mobi|POLARIS|IEMobile|lgtelecom|nokia|SonyEricsson/i) || null != e.match(/LG|SAMSUNG|Samsung/)))
                                                return console.log("screen share is not available");
                                            var e;
                                            u && (d ? (delete y.share,
                                                ...
                                                (n_fn) ? n_fn(false) : false,
                                                o.createMediaStream(m).then((function(n) {
                                                ...
                                                n.getTracks().length && (m = u.getTracks().reduce((function(n, e) {
                                                    ...
                                                    (n_fn) ? n_fn(true) : true,
                                                    d = n.getTracks().reduce((function(n, e) {
                                                        return n[e.kind] = e.id,
                                                            n
                                                    }), {}),
                                                    n.getTracks().forEach((function(n) {
                                        ...
                                        t.onmessage = function(e) {
                                                ...
                                                if ("file" == t.type) {
                                                    ...
                                                    c = Uint8Array.from(atob(c), (function(n) {
                                                        ...
                                                        0 == o && (r[i] = Object.assign(a, {
                                                            data: new Uint8Array(t.size)
                                                        })),
                                                        r[i].data.set(c, o),
                                                        o + c.byteLength == t.size && (r[i].data = new Blob([r[i].data], {
                                                                type: t.mime
                                                            }),
                                                            n.emit("receivedata", r[i]),
                                                            delete r[i])
                                                } else
                                                    console.log(t)
                                            },
